...
#ifndef PROOF_VERIFIER_ASSIGNER_PROOF_HPP
#define PROOF_VERIFIER_ASSIGNER_PROOF_HPP
...
#include <nil/proof-verifier/detail/utils.hpp>
...
namespace nil {
    namespace proof_verifier {
        ...
        bool verifier(boost::filesystem::path circuit_file_name, boost::filesystem::path assignment_table_file_name, boost::filesystem::path proof_file) {
            ...
            auto fri_params = proof_verifier::detail::create_fri_params<typename lpc_type::fri_type, BlueprintFieldType>(table_rows_log);
...
#endif    // PROOF_VERIFIER_ASSIGNER_PROOF_HPP
