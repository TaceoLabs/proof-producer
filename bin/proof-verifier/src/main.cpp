...
#include <nil/proof-verifier/aspects/args.hpp>
#include <nil/proof-verifier/aspects/path.hpp>
#include <nil/proof-verifier/aspects/configuration.hpp>
#include <nil/proof-verifier/aspects/verifier_vanilla.hpp>
#include <nil/proof-verifier/detail/configurable.hpp>
#include <nil/proof-verifier/verifier.hpp>
...
inline bool insert_aspects(boost::application::context &ctx, Application &app, Aspects... args) {
    ...
    ::boost::shared_ptr<nil::proof_verifier::aspects::path> path_aspect =
        boost::make_shared<nil::proof_verifier::aspects::path>();

    ctx.insert<nil::proof_verifier::aspects::path>(path_aspect);
    ctx.insert<nil::proof_verifier::aspects::configuration>(
        boost::make_shared<nil::proof_verifier::aspects::configuration>(path_aspect));
    ctx.insert<nil::proof_verifier::aspects::verifier_vanilla>(
        boost::make_shared<nil::proof_verifier::aspects::verifier_vanilla>(path_aspect));
...
inline bool configure_aspects(boost::application::context &ctx, Application &app) {
    typedef nil::proof_verifier::detail::configurable<nil::dbms::plugin::variables_map,
    ...
    boost::shared_ptr<nil::proof_verifier::aspects::args> args = ctx.find<nil::proof_verifier::aspects::args>(guard);
    boost::shared_ptr<nil::proof_verifier::aspects::configuration> cfg =
        ctx.find<nil::proof_verifier::aspects::configuration>(guard);
...
struct verifier {
    verifier(boost::application::context &context) : context_(context) {
    }

    template <typename BlueprintFieldType>
    int run_verifier() {
        auto verifier_task = [&] {
            return nil::proof_verifier::verifier<BlueprintFieldType>(circuit_file_path, assignment_file_path, proof_file) ? 0 : 1;
        };
    ...
    int operator()() {
        ...
        circuit_file_path = context_.find<nil::proof_verifier::aspects::verifier_vanilla>()->input_circuit_file_path();
        assignment_file_path =
            context_.find<nil::proof_verifier::aspects::verifier_vanilla>()->input_assignment_file_path();


        proof_file = context_.find<nil::proof_verifier::aspects::verifier_vanilla>()->output_proof_file_path();

        nil::proof_verifier::detail::CurveType curve_type = context_.find<nil::proof_verifier::aspects::verifier_vanilla>()->curve_type();
        switch (curve_type) {
            case nil::proof_verifier::detail::PALLAS: {
                using curve_type = nil::crypto3::algebra::curves::pallas;
                using BlueprintFieldType = typename curve_type::base_field_type;
                return run_verifier<BlueprintFieldType>();
            }
            case nil::proof_verifier::detail::VESTA: {
                BOOST_LOG_TRIVIAL(error) << "vesta curve based circuits are not supported yet";
                return 1;
            }
            case nil::proof_verifier::detail::ED25519: {
                BOOST_LOG_TRIVIAL(error) << "ed25519 curve based circuits are not supported yet";
                return 1;
            }
            case nil::proof_verifier::detail::BLS12381: {
...
int main(int argc, char *argv[]) {
    ...
    boost::application::auto_handler<verifier> app(ctx);

    if (!insert_aspects(ctx, app, boost::make_shared<nil::proof_verifier::aspects::args>(argc, argv))) {
